...
roles = ['Super Admin', 'Company Admin', 'HR Admin', 'HR']
...
users_data = [
  ...
  { first_name: 'companyadmin', last_name: 'two', email: 'companyadmin.two@gmail.com', password: 'Companyadmin@12345', role_name: 'Company Admin' },
