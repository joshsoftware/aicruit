      ...
      {!isCandidate && (
        <div className="flex">
          <motion.button
            ...
            className="flex items-center gap-2 bg-white text-indigo-600 font-medium px-4 py-2 rounded-lg shadow-md hover:bg-gray-100 transition-all mr-3"
          >
            <Edit size={16} /> View All Applications
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.05 }}
            onClick={onEdit}
